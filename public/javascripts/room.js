...
var room={
    ...
    sendWhMsg:function(txtObj){
        ...
        txtObj.html("");//清空内容
        var dasData = {groupId:room.userInfo.groupId, mobile:room.userInfo.mobilePhone, clientGroup:'',
            userName:room.userInfo.nickname,roomName:decodeURI(common.getUrlParam('roomName', true)),userSource:'web',useEquipment:'',
            tradingAccount:'',tradingPlatform:'',platformType:0,
            groupType:room.userInfo.groupType,operateEntrance:'',operationType:8,visitorId:'',
            sid:room.userInfo.sid,nickname:room.userInfo.nickname,email:'',videoId:'',videoName:'',courseId:'',courseName:'',teacherId:'',teacherName:''};
            ...
            if(e.keyCode==13){//按回车键并且当@提示选择隐藏后按回车才发送消息
                ...
                if($('.ui-autocomplete').is(':hidden')) {
                    ...
                    var dasData = {groupId:room.userInfo.groupId, mobile:room.userInfo.mobilePhone, clientGroup:'',
                        userName:room.userInfo.nickname,roomName:decodeURI(common.getUrlParam('roomName', true)),userSource:'web',useEquipment:'',
                        tradingAccount:'',tradingPlatform:'',platformType:0,
                        groupType:room.userInfo.groupType,operateEntrance:'',operationType:2,visitorId:'',
                        sid:room.userInfo.sid,nickname:room.userInfo.nickname,email:'',videoId:'',videoName:'',courseId:'',courseName:'',teacherId:'',teacherName:''};
                    if(room.userInfo.userType==1){
                        dasData.clientGroup = 'admin';//return "管理员";
                    }else if(room.userInfo.userType==2){
